# Generated by Django 3.2.5 on 2022-04-30 12:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('cid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ovc_app.card')),
            ],
        ),
        migrations.CreateModel(
            name='OrderHistory',
            fields=[
                ...
                ('ucid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ovc_app.usercardinformation')),
            ],
        ),
        migrations.CreateModel(
            name='User',
